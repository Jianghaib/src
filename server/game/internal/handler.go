...
func init() {
	...
	handler(msg.MsgID_Ok /*&msg.Ok{}*/, handleOk)
	handler(msg.MsgID_Up /*&msg.Up{}*/, handleUp)
	handler(msg.MsgID_Left /*&msg.Left{}*/, handleLeft)
	handler(msg.MsgID_Right /*&msg.Right{}*/, handleRight)
	handler(msg.MsgID_Match /*&msg.Match{}*/, handleMatch)
	handler(msg.MsgID_Admin /*&msg.Admin{}*/, handleAdmin)
	handler(msg.MsgID_Order /*&msg.Order{}*/, handleOrder)
	handler(msg.MsgID_Finished /*&msg.Finished{}*/, handleFinish)
	handler(msg.MsgID_CREATE_ROLE, handleCreateRole)
}

func handler(msgID int /*m interface{}*/, h interface{}) {
...
func handleCreateRole(args []interface{}){
	...
	a := args[0].(gate.Agent)
	tmp := int32(msg.MsgID_CREATE_ROLE)
